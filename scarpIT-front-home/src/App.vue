    ...
    <main>
        ...
        <div id="servicos">
            ...
            <div id="botoes-servicos" style="padding-top: 4rem;">
                <BotaoServico :img="imgSre" titulo="SRE" @click="mudarServico('SRE')"></BotaoServico>
        ...
        <div id="scarpedia">
            <div id="scarpedia-titulo">
                <h1>ScarPedia</h1>
            </div>
            <div id="scarpedia-grid">
                <div id="principal" @click="clickBtnBlk('https://sites.google.com/scarpit.tech/scarpit/wiki/performance/democratiza%C3%A7%C3%A3o?authuser=0#h.32d36c9268f4bf0d_213')">
                    <div class="img-principal">
                        <img src="./assets/apmw.png" alt="">
                    </div>
                    <h2><strong>O que é APM?</strong></h2>
                    <p>Application Performance Management garante que seja atingido o desempenho e estabilidade de um sistema com o menor custo possível.</p>
                </div>
                <div id="svg-divisao">
                ...
                <div id="secundaria">
                    <div id="um" @click="clickBtnBlk('https://sites.google.com/scarpit.tech/scarpit/wiki/performance/democratiza%C3%A7%C3%A3o?authuser=0#h.6bf36768fe9ba4e0_7')">
                    ...
                    <div id="dois" @click="clickBtnBlk('https://sites.google.com/scarpit.tech/scarpit/wiki/performance/democratiza%C3%A7%C3%A3o?authuser=0#h.6bf36768fe9ba4e0_37')">
        ...
        <div id="contato">
            <div id="formulario">
                ...
                <p>Converse com nossos especialistas para te ajudar a alcançar e manter um ambiente altamente disponível e robusto. Se você escapar para as montanhas e sem sinal, estaremos aqui, cuidando para que tudo funcione perfeitamente.</p>
                <!-- <div id="inputs">
            ...
            <div id="info">
                ...
                <div id="phone">
                    <img src="./assets/iconPhone.svg" alt="iconePhone" @click="clickBtnBlk('https://wa.me/+5513991486248?text=%F0%9F%96%96+Ol%C3%A1%21+')" style="padding-right: 12px;">
...
<script setup lang="ts">
    ...
    onMounted(() => {
        servicoDescricao.value.style.display = 'none';
    });
    ...
    function mudarServico(tipo: string){
        if(tipo == servicoTitulo.value) {
            servicoDescricao.value.classList.remove('scale-in-top');
            servicoDescricao.value.classList.remove('scale-out-top');
            servicoDescricao.value.classList.add('scale-out-top');
            servicoTitulo.value = '';
            setTimeout(() => {
                servicoDescricao.value.style.display = 'none';
            }, 400);
        }else{
            servicoDescricao.value.style.display = '';
            ...
            switch(tipo){
                case 'SRE':
                    {
                        servicoImg.value = imgSre;
                        servicoTitulo.value = 'SRE';
                        servicoFrase.value = 'Nossa expertise em Site Reliability Engineering (SRE) permite que suas operações digitais ocorram sem problemas. Com abordagens nativas e de código aberto, oferecemos soluções para aprimorar a observabilidade, aprimorar a resiliência e promover a melhoria contínua. Trabalhamos nos bastidores para que você possa se destacar na vanguarda.';
                        break;
                    };
    
                case 'NUVEM':
                    {
                        servicoImg.value = imgNuvem;
                        servicoTitulo.value = 'NUVEM';
                        servicoFrase.value = 'Mergulhe no mundo da tecnologia em nuvem com confiança. Nossos especialistas em nuvem estão preparados para criar e implementar soluções modernas e bem estruturadas. Seja adotando uma abordagem multi-nuvem, híbrida ou migrando completamente, estamos aqui para transformar sua jornada para a nuvem em uma experiência tranquila e eficiente.';
                        break;
                    };
    
                case 'APM':
                    {
                        servicoImg.value = imgApm;
                        servicoTitulo.value = 'APM';
                        servicoFrase.value = 'O desempenho do aplicativo é essencial para o sucesso nos negócios digitais. Nossos serviços de Application Performance Management (APM) oferecem testes de desempenho meticulosos, otimizações avançadas e solução de problemas abrangente. Acelere seus aplicativos, minimize gargalos e proporcione uma experiência excepcional aos usuários finais.';
                        break;
                    };
            }
        }
